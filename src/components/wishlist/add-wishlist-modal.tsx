                  ...
                  {PRIORITIES.map(p => (
                    <button
                      ...
                      className={cn(
                        ...
                        priority === p.value ? "bg-white dark:bg-stone-800 shadow-md border border-white/40 dark:border-white/10 text-foreground" : "text-muted-foreground hover:text-foreground"
                      )}
                    >
